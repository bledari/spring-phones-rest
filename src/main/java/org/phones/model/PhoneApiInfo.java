...
@Entity
@Table(name = "phone_api_info")
public class PhoneApiInfo {
    @Id
    ...
    @Size(min = 1, max = 200, message = "display type must be between 1 and 200 characters")
    private String displayType;

    @Column(name = "display_size")
    @NotBlank(message = "display size is mandatory")
    @Size(min = 1, max = 200, message = "display size must be between 1 and 200 characters")
